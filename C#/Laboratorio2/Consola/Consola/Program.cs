...
namespace Consola
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Empresa ClienteEmpresa1 = new Empresa("Mc Donals", "20-12345678-8", "Ronald", "ronaldmacdonalds@hotmail.com", "4999-2500", "Corrientes 498");
            ClienteIndividuo ClienteIndividuo1 = new ClienteIndividuo("Roman", "Riquelme", "romancapo@hotmail.com", "4000-0123", "La bombonera", "20-87654321-8");
            ...
            Empresa Proveedor1 = new Empresa("El bolita", "20-11111111-8", "Luis", "elbol_2015@hotmail.com", "4552-2001", "El mercado central, al lado");
            ...
            while (comando != "Salir" || comando != "salir")
            {
                ...
                switch (comando)
                {
                    ...
                    case "Empresa":
                    case "empresa":
                        MostrarEmpresa(ClienteEmpresa1);
                        break;
                    case "Individuo":
                    case "individuo":
        ...
        // Método para mostrar datos de una empresa
        private static void MostrarEmpresa(Empresa emp)
        {
            Console.WriteLine("Empresa");
            Console.WriteLine();
            Console.WriteLine("Nombre: " + emp.Nombre);
            Console.WriteLine("C.U.I.T.: " + emp.CUIT);
            Console.WriteLine("Contacto: " + emp.Contacto);
            Console.WriteLine("Email: " + emp.Email);
            Console.WriteLine("Teléfono: " + emp.Telefono);
            Console.WriteLine("Dirección: " + emp.Direccion);
            Console.WriteLine();
            Console.WriteLine();
        }
